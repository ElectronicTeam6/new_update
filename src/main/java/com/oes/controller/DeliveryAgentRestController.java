...
public class DeliveryAgentRestController {
	...
	public ResponseEntity<MyDTO> addDeliveryAgentByUser(@PathVariable String username,@PathVariable String deliveryStatus,@PathVariable String payment,@PathVariable String city,@PathVariable String productName,@PathVariable int totalOrderCost)
	{
		...
		try {
			...
			if(savedUser != null)
			{
				DeliveryAgent deliveryAgent = new DeliveryAgent(deliveryStatus, payment,username,city,productName,totalOrderCost,LocalDate.now().toString());
